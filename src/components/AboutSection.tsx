...
const AboutSection = () => {
  return (
    <section id="sobre" className="section-padding max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        >
          <p>
            Olá! Sou o Rafael, um desenvolvedor apaixonado por criar coisas que
            vivem na internet. Meu interesse por desenvolvimento web começou em
            2016, quando decidi experimentar criar temas customizados para
            WordPress — e isso me ensinou muito sobre HTML, CSS e como a web
            funciona.
          </p>
          <p>
